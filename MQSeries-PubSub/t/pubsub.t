#
# $Id: pubsub.t,v 9.3 1999/11/03 00:12:46 wpm Exp $
#
...
END {print "not ok 1\n" unless $loaded;}
use MQSeries::PubSub::Broker 		1.06;
use MQSeries::PubSub::Stream 		1.06;
use MQSeries::PubSub::Message 		1.06;
use MQSeries::PubSub::AdminMessage 	1.06;
$loaded = 1;
print "ok 1\n";
